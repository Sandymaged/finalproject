...
src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBiguxwnjCi4zYMJBNj4mB86Kf-jG-pRfw">
    ...
    <h3>  Choose your Location and confirm it by your username </h3>
    ...
    <script>
        ...
        var addMarker = google.maps.event.addListener(map, 'click', function(e) {
            ...
            var marker = new google.maps.Marker({
                ...
                "            <tr>\n" +
                "                <td><a>nameuser:</a></td>\n" +
                "                <td><textarea  id='manual_nameuser' placeholder='nameuser'></textarea></td></tr>\n" +
        ...
        for (i = 0; i < locations.length; i++) {
            marker = new google.maps.Marker({
                ...
                "<tr>\n" +
                "<td><a>nameuser:</a></td>\n" +
                "<td><textarea disabled id='manual_nameuser' placeholder='nameuser'>"+locations[i][3]+"</textarea></td></tr>\n" +
                "</table>\n" +
                "</div>"
            });
        ...
        function saveData(lat,lng) {
            ...
            downloadUrl(url, function(data, responseCode) {
                if (responseCode === 200  && data.length > 1) {
                    ...
                    infowindow.close();
                    infowindow.setContent("<div style=' color: purple; font-size: 25px;'>Done! <br> Waiting you to make PCR!!<br><a href='http://localhost:8000/'>Back Homepage</a></div>");
